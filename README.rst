...
The list of search engines that it matches is borrowed from Spiros Denaxas's ``URI::ParseSearchString project`` (https://github.com/spiros/URI-ParseSearchString).
